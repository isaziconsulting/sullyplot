...
#' @export
auto_dash <- function(data, num_plots = 6, custom_description="", dash_model="gpt-4", code_model="gpt-4", temperature=0.1, num_design_attempts=2, num_code_attempts=5, max_cols=10, save_messages=TRUE, save_dir="sullyplot_messages", save_name="auto_dash") {
