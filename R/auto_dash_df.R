...
#'
#' This function automatically generates a dashboard of `ggplot` objects from your input data frame.
#' It allows you to specify the number of plots and a custom description of your dashboard.
#'
#' @param file_df Your input dataframe to be plotted.
...
#'
#' @export
auto_dash_df <- function(file_df, num_plots = 6, custom_description="", dash_model="gpt-4", code_model="gpt-4", num_design_attempts=1, num_code_attempts=5, max_cols=10, save_messages=FALSE, save_dir="", save_name="auto_dash") {
