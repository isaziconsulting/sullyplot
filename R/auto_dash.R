...
#' @export
auto_dash <- function(file_path, num_plots = 4, custom_description="", dash_model="gpt-4", code_model="gpt-4", num_design_attempts=1, num_code_attempts=5, save_messages=FALSE, save_dir="", save_name="auto_dash") {
